            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Skills Aquired  <a class="btn btn-info btn-fill btn-wd" href="<?php echo base_url(); ?>profile/add_skill">Add Skill<i class="ti-plus"></i></a></h4>
                            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="<?php echo base_url(); ?>profile/update_skill/<?php echo $row->id; ?>"><i class="ti-pencil"></i></a> | 
            <a href="<?php echo base_url(); ?>profile/delete_skill/<?php echo $row->id; ?>"><i class="ti-trash"></i></a></td>
