...
<head>
	...
	<title>Add Projects Details</title>
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Add a New Project</a>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="<?php echo base_url(); ?>profile/project" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Project Name</label>
                                                <input type="text" name="project_name" class="form-control border-input" placeholder="Project Name" required="" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="technology" class="form-control border-input" placeholder="Technology" required="" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Status</label>
                                                <input type="text" name="status" class="form-control border-input" placeholder="Status" required="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="link" class="form-control border-input" placeholder="Link to website" required="" />
                                            </div>
                                        </div>
                                    </div>

                                    <div class="text-center">
                                        <input name="" type="submit" class="btn btn-info btn-fill btn-wd" value="Add">
                                    </div>
