		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Skills and Edcation</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Educational Details <a class="btn btn-info btn-fill btn-wd" href="<?php echo base_url(); ?>profile/add_education">Add Education<i class="ti-plus"></i></a></h4>
                                </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td><a href="<?php echo base_url(); ?>profile/update_education/<?php echo $row->id; ?>"><i class="ti-pencil"></i></a> | 
            <a href="<?php echo base_url(); ?>profile/delete_education/<?php echo $row->id; ?>"><i class="ti-trash"></i></a></td>
                                        </tr>
                                    <?php } ?>
