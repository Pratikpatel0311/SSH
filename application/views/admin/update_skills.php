		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Edit Skills</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                                           
						<li>
                            <a href="<?php echo base_url(); ?>portfolio/logout">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Edit Skills</h4>
                            </div>
                            <div class="content">
                                <form action="<?php echo base_url(); ?>profile/update_skills" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Skill Name</label>
                                                <input type="text" name="skillname" class="form-control border-input" placeholder="Skill Name" value="<?php echo $skill->skill_name; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="proficiency" class="form-control border-input" placeholder="Proficiency" value="<?php echo $skill->proficiency; ?>">
                                            </div>
                                        </div>
                                    </div>
