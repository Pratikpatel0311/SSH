...
<head>
	...
	<title>List of Projects done</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <h4 class="title">Projects Details <a class="btn btn-info btn-fill btn-wd" href="<?php echo base_url(); ?>profile/add_project">Add Project<i class="ti-plus"></i></a></h4>
                                </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>profile/update_project/<?php echo $row->id; ?>"><i class="ti-pencil"></i></a></td>
                                        </tr>
                                    <?php } ?>
