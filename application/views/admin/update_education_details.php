                ...
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="<?php echo base_url(); ?>profile/update_education_details" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Education Level</label>
                                                <input type="text" name="education" class="form-control border-input" placeholder="Education" value="<?php echo $education->education_level; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="university" class="form-control border-input" placeholder="University" value="<?php echo $education->university; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="duration" class="form-control border-input" placeholder="Duration" value="<?php echo $education->duration; ?>">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="text-center">
                                        <input type="hidden" value="<?php echo $education->id; ?>"  name="id" />
