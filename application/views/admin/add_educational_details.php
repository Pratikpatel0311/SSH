                ...
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="<?php echo base_url(); ?>profile/education" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Education Level</label>
                                                <input type="text" name="education" class="form-control border-input" placeholder="Education" required="" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="university" class="form-control border-input" placeholder="University" required="" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="duration" class="form-control border-input" placeholder="Duration"" required="">
                                            </div>
                                        </div>
                                    </div>
